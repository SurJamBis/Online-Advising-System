...
public class Advisoraccount extends JFrame {
		...
		private static JTextField Department;
	...
	public Advisoraccount ()
		...
		public static void getDetails()
	    {
	        try
	        {
	           ...
	           rs = st.executeQuery("select * from onlinesystem.advisor where username = \"" + 
	...
	//	ID.setColumns(10);
		...
		lblDepartment.setBounds(272, 319, 89, 31);
		...
		Department.setBounds(371, 311, 162, 60);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e)
			{
		        ...
		        {   // byte[] pto = null;
			           ...
			           String st = "update onlinesystem.advisor set First_Name=?, Last_Name=?,Department=?,Email=?, Phone_No=?,  image=? "
