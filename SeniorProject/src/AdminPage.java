	...
	public AdminPage() {
		...
		btnAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				AdminAccountPage  fr = new AdminAccountPage();
				fr.setVisible(true);
			}
		...
		JButton btnFaculty = new JButton("ADVISOR LIST");
		...
		btnFaculty.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				AdminAccessToAdvisorPage adv = new AdminAccessToAdvisorPage();
				adv.setVisible(true);
			}
		});
		...
		btnsignout.setBounds(0, 566, 259, 42);
		...
		btnClasses.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				AdminAccessToClasses cla = new AdminAccessToClasses();
				cla.setVisible(true);
		...
		btnStudentList.setFont(new Font("Stencil", Font.PLAIN, 18));
		btnStudentList.setForeground(new Color(255, 255, 255));
		btnStudentList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
			
				AdminAccessToStudent adst = new AdminAccessToStudent();
				adst.setVisible(true);
			}
		});
		btnStudentList.setBackground(new Color(102, 0, 0));
		btnStudentList.setBounds(0, 442, 259, 42);
		...
		label_2.setIcon(new ImageIcon("C:\\Users\\jamun\\eclipse-workspace\\SeniorProject\\image\\studentInfo.png"));
		...
		label_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) 
			{
				...
				AdminAccessToClasses clpage = new AdminAccessToClasses();
				clpage.setVisible(true);
			}
		});
		label_3.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		label_3.setIcon(new ImageIcon("C:\\Users\\jamun\\eclipse-workspace\\SeniorProject\\image\\classes1.png"));
		...
		JLabel lblNewLabel_4 = new JLabel("ADMIN PAGE");
		lblNewLabel_4.setFont(new Font("Stencil", Font.BOLD, 30));
		lblNewLabel_4.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_4.setBounds(149, 128, 232, 51);
