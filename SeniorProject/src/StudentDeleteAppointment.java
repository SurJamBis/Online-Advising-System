...
public class StudentDeleteAppointment extends JFrame {
	...
	public StudentDeleteAppointment ()
	{
		TrioAdvisors1();
	getDetails();
		 ...
		 try
	        {
	           ...
	           ResultSet rs;
	           String stt= "SELECT advisor.First_Name, advisor.Last_name, meeting.slot, meeting.Date, meeting.Month_Year,onlinesystem.meeting_has_advisor.Status as Status "
	           		...
	           		+ "where student.Username in (\""+   loginPage.textusername1.getText() + "\")";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudentDeleteAppointment frame = new StudentDeleteAppointment();
	...
	public void TrioAdvisors1() {
		...
		panel_4.setBounds(319, 297, 205, 37);
		panel_3.add(panel_4);
		...
		Delete_Button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
	            ...
	            String sttt =(" DELETE FROM onlinesystem.student_has_advisor WHERE student_ID = ((SELECT ID FROM onlinesystem.student "
...
//		      	           	    
		...
		Delete_Button.setFont(new Font("Tahoma", Font.BOLD, 15));
			...
			scrollPane.setViewportView(table_1);
				...
				panel_4_1.setBounds(40, 297, 205, 37);
